        ...
        <div className="w-full md:w-[67%] lg:w-[40%] lg:ml-20">
          <form onSubmit={onSubmit}>
            ...
            <div className="flex justify-between whitespace-nowrap text-sm sm:text-lg mb-6">
              <p>Don't have account? <Link to= "/sign-up" className="text-red-600 hover:text-red-800 transition duration-200 ease-in-out ml-1">Register</Link></p>
            ...
            <button type="submit" className="w-full text-white bg-blue-600 px-7 py-2 text-sm font-medium uppercase rounded shadow-md hover:bg-blue-700 transition duration-200 ease-in-out hover:shadow-lg active:bg-blue-800">Send reset password</button>
